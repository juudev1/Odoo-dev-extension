odoo.define('odoo_dev.sale.ListRenderer', ['@sale/js/sale_order_line_field/sale_order_line_field', '@web/core/utils/patch', 'odoo_dev.version_utils', '@web/core/utils/hooks', '@web/core/l10n/translation'], function (require) {
    // const { useState } = require("@odoo/owl"); // Ya no necesitamos devSidebarState local
    const { SaleOrderLineListRenderer } = require('@sale/js/sale_order_line_field/sale_order_line_field');
    ...
    if (odooVersion.isV16) {
        ...
        SaleOrderLineListRenderer.recordRowTemplate = "odoo_dev.sale_ListRenderer.RecordRow"; 
    ...
    return {
        SaleOrderLineListRenderer: SaleOrderLineListRenderer
    };
});