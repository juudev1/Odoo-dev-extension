...
var ExtensionCore = /*#__PURE__*/function () {
  ...
  return _createClass(ExtensionCore, null, [{
    ...
    get: function get() {
      ...
      return {
        templates: [this.getUrl('src/injected/views/list/list_renderer.xml'), this.getUrl('src/injected/views/list/sale_order_line.xml'), this.getUrl('src/injected/views/list/stock_move.xml'), this.getUrl('src/injected/views/form/form_view.xml'), this.getUrl('src/injected/views/field.xml'), this.getUrl('src/injected/views/view_button/view_button.xml'), this.getUrl('src/injected/views/custom/sidebar_dev.xml')],
    ...
    key: "getOdooVersion",
    value: function getOdooVersion() {
      var versionInfo = odoo.info && odoo.info.server_version_info;
      var majorVersion = versionInfo && versionInfo.length > 0 ? versionInfo[0] : 0; // Default a 0 si no se encuentra
...
function _initializeOdooDev() {
  _initializeOdooDev = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    ...
    var loadScript, earlyUrlCheck, earlyInjectionCheck, odooVersion, extensionUrl, srcFolder, globalUrlScript, urlCheck, injectionCheck, remainingScripts;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 10:
          odooVersion = _core_extension_core_js__WEBPACK_IMPORTED_MODULE_0__["default"].getOdooVersion();
        ...
        case 16:
          ...
          injectionCheck = urlCheck.shouldInjectOdooModules(); // console.log("[Odoo Dev Index] URL analysis:", {
        ...
        case 39:
          ...
          // ****** Webclient Patches ******
          "./webclient.js", "./tooltip/js/tooltip.js", "./views/form/form_compiler.js", "./views/list/list_renderer.js"].concat(_toConsumableArray(odooVersion.isV18 ? ["./views/list/sale_order_line.js"] : []), ["./views/list/stock_move.js", "./views/view_button/view_button.js", "./views/field.js", "./form_label.js"]); // Load remaining scripts in parallel
          _context3.next = 42;
